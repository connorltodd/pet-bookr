  ...
  return (
    <div>
      <div className="container m-auto mt-14">
        ...
        <form className="flex justify-center items-center gap-6 w-[90vw] md:w-[384px] m-auto mb-5 md:min-w-[300px] max-w-[500px]">
          <label
        ...
        <div className="mt-12 flex flex-wrap gap-8 justify-center items-center pb-12">
          {/* Business Card */}
          {businesses.map((business: Business) => (
            <div className="card bg-base-100 w-[90vw] md:w-96 shadow-xl">
